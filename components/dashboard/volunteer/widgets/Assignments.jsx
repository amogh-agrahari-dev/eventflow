...
export default function Assignments({ className, delay = 0.15 }) {
  return (
    <WidgetCard 
            ...
            return (
              ...
              >
                ...
                <motion.div
                  ...
                  className="w-10 h-10 rounded-xl bg-vol-accent/10 border border-vol-accent/20 flex items-center justify-center shrink-0 text-vol-accent2 group-hover:bg-vol-accent/20 group-hover:border-vol-accent/40 transition-all duration-200"
                >
                  <Icon size={18} />
                </motion.div>
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between gap-1.5 mb-0.5">
                    ...
                    <span className={clsx(
                      ...
                      isConfirmed 
                        ? "bg-vol-success/15 text-vol-success border-vol-success/25" 
                  ...
                  <div className="flex items-center gap-1.5 text-[11px] text-gray-500">
                    ...
                    <span className="truncate">{assignment.date}</span>
                  </div>
                </div>

                <ChevronRight 
                  size={14} 
                  className="text-vol-border opacity-0 group-hover:opacity-100 group-hover:text-vol-accent2 transition-all duration-200 shrink-0 hidden sm:block" 
                />
              </motion.div>
            );
          })}
