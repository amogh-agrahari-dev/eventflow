        ...
        {announcements.map((announcement, idx) => {
          ...
          return (
            <motion.div
              ...
              whileHover={{ x: 4 }}
              className="flex gap-4 group cursor-pointer p-2 rounded-xl hover:bg-vol-border/20 transition-all duration-200 relative"
            >
              {/* Hover accent bar */}
              ...
              <div className={`w-10 h-10 rounded-full flex items-center justify-center shrink-0 text-vol-accent2 border transition-all duration-200 ${
                announcement.isNew
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-0.5">
                  ...
                  {announcement.isNew && (
                    <span className="px-1.5 py-0.5 rounded text-[8px] font-bold bg-vol-accent/20 text-vol-accent2 border border-vol-accent/30 uppercase tracking-wider shrink-0">
                      New
                    </span>
                  )}
                </div>
