...
export default function AttendeeHeader({ toggleSidebar, toggleMobileSidebar }) {
  ...
  return (
    <header className="h-16 md:h-[72px] shrink-0 border-b border-vol-border/50 bg-vol-bg/95 backdrop-blur z-10 flex items-center justify-between px-4 md:px-6 sticky top-0">
      <div className="flex items-center gap-2 sm:gap-4 min-w-0">
        ...
        <h1 className="text-base sm:text-lg md:text-xl font-semibold text-white truncate">Attendee Dashboard</h1>
      </div>
